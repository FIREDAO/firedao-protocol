...
export interface TestFireContract extends Truffle.Contract<TestFireInstance> {
  "new"(
    account: string,
    _minter: string,
    meta?: Truffle.TransactionDetails
  ): Promise<TestFireInstance>;
}
...
export interface TestFireInstance extends Truffle.ContractInstance {
