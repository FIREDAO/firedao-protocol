...
export interface YWethContract extends Truffle.Contract<YWethInstance> {
  "new"(
    _token: string,
    _controller: string,
    meta?: Truffle.TransactionDetails
  ): Promise<YWethInstance>;
}
...
export interface YWethInstance extends Truffle.ContractInstance {
  allowance(
    owner: string,
    spender: string,
