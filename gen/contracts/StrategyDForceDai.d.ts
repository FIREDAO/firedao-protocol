...
export interface StrategyDForceDaiContract
  extends Truffle.Contract<StrategyDForceDaiInstance> {
  "new"(
    _controller: string,
    meta?: Truffle.TransactionDetails
  ): Promise<StrategyDForceDaiInstance>;
}

type AllEvents = never;

export interface StrategyDForceDaiInstance extends Truffle.ContractInstance {
  balanceOf(txDetails?: Truffle.TransactionDetails): Promise<BN>;

  balanceOfDDai(txDetails?: Truffle.TransactionDetails): Promise<BN>;
  ...
  ddai(txDetails?: Truffle.TransactionDetails): Promise<string>;
