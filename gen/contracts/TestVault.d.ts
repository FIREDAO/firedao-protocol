...
export interface TestVaultContract extends Truffle.Contract<TestVaultInstance> {
  "new"(
    _token: string,
    _rp: string,
    meta?: Truffle.TransactionDetails
  ): Promise<TestVaultInstance>;
}
...
export interface TestVaultInstance extends Truffle.ContractInstance {
  allowance(
    owner: string,
    spender: string,
  ...
  rp(txDetails?: Truffle.TransactionDetails): Promise<string>;
