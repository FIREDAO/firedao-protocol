...
export interface StrategyDaiCurveContract
  extends Truffle.Contract<StrategyDaiCurveInstance> {
  "new"(
    _controller: string,
    _yycrv: string,
    meta?: Truffle.TransactionDetails
  ): Promise<StrategyDaiCurveInstance>;
}

type AllEvents = never;

export interface StrategyDaiCurveInstance extends Truffle.ContractInstance {
