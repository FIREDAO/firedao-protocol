...
export interface BVaultContract extends Truffle.Contract<BVaultInstance> {
  "new"(
    _token: string,
    _controller: string,
    meta?: Truffle.TransactionDetails
  ): Promise<BVaultInstance>;
}
...
export interface BVaultInstance extends Truffle.ContractInstance {
  allowance(
    owner: string,
    spender: string,
