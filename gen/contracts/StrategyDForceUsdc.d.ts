...
export interface StrategyDForceUsdcContract
  extends Truffle.Contract<StrategyDForceUsdcInstance> {
  "new"(
    _controller: string,
    meta?: Truffle.TransactionDetails
  ): Promise<StrategyDForceUsdcInstance>;
}

type AllEvents = never;

export interface StrategyDForceUsdcInstance extends Truffle.ContractInstance {
  balanceOf(txDetails?: Truffle.TransactionDetails): Promise<BN>;

  balanceOfDUSDC(txDetails?: Truffle.TransactionDetails): Promise<BN>;
  ...
  dusdc(txDetails?: Truffle.TransactionDetails): Promise<string>;
