...
export interface TestRewardPoolContract
  extends Truffle.Contract<TestRewardPoolInstance> {
  "new"(
    _rewardToken: string,
    _lpToken: string,
  ...
  ): Promise<TestRewardPoolInstance>;
}
...
export interface TestRewardPoolInstance extends Truffle.ContractInstance {
  balanceOf(
    account: string,
