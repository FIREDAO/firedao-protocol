...
export interface TestStrategyContract
  extends Truffle.Contract<TestStrategyInstance> {
  "new"(
    _controller: string,
    _want: string,
    _tv: string,
  ...
  ): Promise<TestStrategyInstance>;
}

type AllEvents = never;

export interface TestStrategyInstance extends Truffle.ContractInstance {
  balanceOf(txDetails?: Truffle.TransactionDetails): Promise<BN>;

  balanceOfPool(txDetails?: Truffle.TransactionDetails): Promise<BN>;

  balanceOfTV(txDetails?: Truffle.TransactionDetails): Promise<BN>;
