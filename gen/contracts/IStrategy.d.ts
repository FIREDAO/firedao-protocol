...
export interface IStrategyContract extends Truffle.Contract<IStrategyInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IStrategyInstance>;
}

type AllEvents = never;

export interface IStrategyInstance extends Truffle.ContractInstance {
