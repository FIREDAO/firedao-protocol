...
module.exports = async function (deployer, networks, accounts) {
    admin = accounts[4];
    // strategist = accounts[5];
    rewarder = admin;
    // governance = accounts[7];

    /* only for test  >>>>>>>>>>>> */
    // const dai = await TestToken.new("Dai Stablecoin", "DAI", 18, { from: admin });
    // const tusd = await TestToken.new("TrueUSD", "TUSD", 6, { from: admin });
    ...
    yCrvAddress = "0xdF5e0e81Dff6FAF3A7e52BA697820c5e32D806A8";
